...
-- Dumping data for table acc.companies: ~5 rows (approximately)
INSERT INTO `companies` (`id`, `name`, `description`, `created_at`, `theme_color`, `dark_mode`) VALUES
	...
	(13, 'test again', '', '2025-06-08 07:34:42', '#38B2AC', 0);
...
) ENGINE=InnoDB AUTO_INCREMENT=12218 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
CREATE TABLE IF NOT EXISTS `income` (
  ...
  `output_vat` decimal(10,2) DEFAULT '0.00',
  PRIMARY KEY (`id`),
  KEY `company_id` (`company_id`),
  CONSTRAINT `income_ibfk_1` FOREIGN KEY (`company_id`) REFERENCES `companies` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=30576 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
) ENGINE=InnoDB AUTO_INCREMENT=84160 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
) ENGINE=InnoDB AUTO_INCREMENT=41784 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
