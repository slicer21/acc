...
) ENGINE=InnoDB AUTO_INCREMENT=5299 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
CREATE TABLE IF NOT EXISTS `income` (
  ...
  `income_subtype` varchar(100) NOT NULL DEFAULT 'Other',
  `sub_category_actual` varchar(100) DEFAULT 'Other',
  `amount` decimal(12,2) NOT NULL,
  `payment_method` enum('Cash','Check','Bank Transfer','Credit Card','Online') DEFAULT 'Cash',
  `notes` text,
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `company_id` int NOT NULL DEFAULT '1',
  `income_type` varchar(255) NOT NULL DEFAULT 'Unknown',
  PRIMARY KEY (`id`),
  KEY `company_id` (`company_id`),
  CONSTRAINT `income_ibfk_1` FOREIGN KEY (`company_id`) REFERENCES `companies` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=15837 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
) ENGINE=InnoDB AUTO_INCREMENT=38846 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
) ENGINE=InnoDB AUTO_INCREMENT=19437 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
